...
<div id="wrapper">
	...
	<div id="content">
		...
		<form action="includes/process.php?action=update" method="post" onsubmit="return updateLocation(this);" class="form">
			...
			<input type="submit" value="Go" class="button"> &nbsp; [<a style="cursor:pointer;" onclick="document.getElementById('options').style.display=(document.getElementById('options').style.display=='none'?'':'none')">设置</a>]
			<ul id="options">
		...
		<ul id="nav">
			...
			<li class="left"><a href="edit-browser.php">浏览设置</a></li>
			<li class="left"><a href="cookies.php">管理Cookies</a></li>
			<li><a href="disclaimer.php">声明</a></li>            
		</ul>
	</div>
	<div id="footer">
